...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    // Less aggressive on mobile quality to ensure visibility
    if (isMobile && quality === 'high') effectiveQuality = 'medium';

    const qualitySettings = {
      low: { iterations: 32, waveIterations: 1, pixelRatio: 1, precision: 'mediump', stepMultiplier: 1.5 },
      medium: { iterations: 48, waveIterations: 2, pixelRatio: Math.min(window.devicePixelRatio, 1.5), precision: 'mediump', stepMultiplier: 1.2 },
      high: {
        iterations: 80,
        waveIterations: 4,
